...
function renderZomatoGeocode(queryData) {
    ...
    for (var i = 0; i < queryData.length; i++) {
        var ZomatoGeocodeLocation=queryData[i].Location.title;
        var ZomatoGeocodeLocationCoordinates ='Coordinates: ' + queryData[i].Location.latitude + ', ' + queryData[i].Location.longitude;
        var ZomatoGeocodePopularity ='Popularity Index: ' + queryData[i].Popularity.popularity;
        var ZomatoGeocodeNightLifeIndex='Nightlife Index: ' + queryData[i].Popularity.nightlife_index;
        var ZomatoGeocodeTopCuisines='Top Cuisines: ' + queryData[i].Popularity.top_cuisines;

        var ZomatoGeocodeNearbyRestaurantName = queryData[i].geocode.nearby_restaurants.name;
        var ZomatoGeocodeNearbyRestaurantFeaturedImage= queryData[i].geocode.nearby_restaurants.featured_image;
        var ZomatoGeocodeNearbyRestaurantAddress=queryData[i].geocode.nearby_restaurants.location.address;
        var ZomatoGeocodeNearbyRestaurantURL = queryData[i].geocode.nearby_restaurants.url;
        var ZomatoGeocodeNearbyRestaurantAveragecostfortwo='Average cost for two: ' + queryData[i].geocode.nearby_restaurants.location.average_cost_for_two;
        var ZomatoGeocodeNearbyRestaurantPriceRange='Price range: ' + queryData[i].geocode.nearby_restaurants.location.price_range;
        var ZomatoGeocodeNearbyRestaurantUserRating = 'User Rating: ' + queryData[i].geocode.nearby_restaurants.user_rating;
        ...
        "<div class='container-fluid'>"+
            "<div class='row'>"+
                            "<div class='col-6 col-md-12'>"+
                                "<div class='card-body'>"+
                                    "<p class='card-text card-line'>"+"<strong>"+ZomatoGeocodeLocation+"</strong></p>"+
                                    "<p class='card-text card-line'>" + ZomatoGeocodeLocationCoordinates + "</p>" +
                                    "<p class='card-text card-line'>" + ZomatoGeocodePopularity  + "</p>" +
                                    "<p class='card-text card-line'>" + ZomatoGeocodeNightLifeIndex + "</p>" +
                                    "<p class='card-text card-line'>" + ZomatoGeocodeTopCuisines+ "</p>" +
                                "</div>"+
                            "</div>"+
                        "</div>"+
                        "<div class='card-footer'>"+
